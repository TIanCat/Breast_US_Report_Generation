...
def main():
    ...
    parser.add_argument('-itos_path', default="data/text_map/impression_itos_min10.json")     # stoi data 
    parser.add_argument('-stoi_path', default="data/text_map/impression_stoi_min10.json")     # stoi data 
...
def load_model(opt):
    ...
    model = CNNTransformer(
        ...
        en_n_layers= model_opt.en_n_layers,
        de_n_layers= model_opt.de_n_layers,
        n_head= model_opt.n_head,
        d_k= model_opt.d_k,
        d_v= model_opt.d_v,
        dropout= model_opt.dropout,
        src_n_position= model_opt.src_max_len,
        trg_n_position = model_opt.trg_max_len,
